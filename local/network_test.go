...
import (
	...
	apimocks "github.com/lasthyphen/dijetsnode-go-runner/api/mocks"
	"github.com/lasthyphen/dijetsnode-go-runner/local/mocks"
	healthmocks "github.com/lasthyphen/dijetsnode-go-runner/local/mocks/health"
...
func TestWriteFiles(t *testing.T) {
	...
	tmpDir, err := os.MkdirTemp("", "dijets-up-tests-*")
	if err != nil {
		t.Fatal(err)
	}
